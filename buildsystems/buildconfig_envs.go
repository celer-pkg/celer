...
func (b *BuildConfig) setupEnvs() {
	...
	if b.buildSystem.Name() != "cmake" {
		...
		tmpDevDir := b.PortConfig.DepsPath(b.PortConfig.HostName + "-dev")
...
func (b BuildConfig) setupPythonEnvs() {
	...
	if buildtools.PythonTool != nil {
		...
		installedDir := b.PortConfig.DepsPath(b.PortConfig.LibraryDir)
...
func (b *BuildConfig) appendIncludeDir(includeDir string) {
	...
	case "gcc", "clang", "qcc":
		...
		tmpDepsPrefix := b.PortConfig.DepsPath(b.PortConfig.LibraryDir)
