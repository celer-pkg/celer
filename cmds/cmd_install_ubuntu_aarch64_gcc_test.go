...
func TestInstall_AArch64_GCC_Bazel(t *testing.T) {
	t.Run("local_gcc", func(t *testing.T) {
		buildWithAArch64GCC(t, "", "skcms@mirror", false)
	})

	t.Run("portable_gcc", func(t *testing.T) {
		buildWithAArch64GCC(t, ubuntu_aarch64_gcc_11_5_0, "skcms@mirror", false)
	})
}
