...
| `binary_cache` | 二进制缓存配置。Celer 支持缓存构建产物以避免重复编译。[可配置为本地目录或局域网共享文件夹](./advance_binary_cache.md) |
...
- [平台配置进阶](./advance_platform.md)
- [端口配置进阶](./advance_port.md)
- [二进制缓存配置](./advance_binary_cache.md)
- [命令参考](./cmd_install.md)
